...
mixin _$VariacaoStore on _VariacaoStore, Store {
  final _$visibilidadeListaMoedasAtom =
      Atom(name: '_VariacaoStore.visibilidadeListaMoedas');
  ...
  final _$visibilidadeListaMoedasConversaoAtom =
      Atom(name: '_VariacaoStore.visibilidadeListaMoedasConversao');
  ...
  final _$tipoMoedaAtom = Atom(name: '_VariacaoStore.tipoMoeda');
  ...
  final _$_VariacaoStoreActionController =
      ActionController(name: '_VariacaoStore');

  @override
  void trocaVisibilidadeListaMoedas() {
    final _$actionInfo = _$_VariacaoStoreActionController.startAction(
        name: '_VariacaoStore.trocaVisibilidadeListaMoedas');
    try {
      return super.trocaVisibilidadeListaMoedas();
    } finally {
      _$_VariacaoStoreActionController.endAction(_$actionInfo);
    }
  }
  ...
  void trocaVisibilidadeListaMoedasConversao() {
    final _$actionInfo = _$_VariacaoStoreActionController.startAction(
        name: '_VariacaoStore.trocaVisibilidadeListaMoedasConversao');
    try {
  ...
  void setTipoMoeda(dynamic _value) {
    final _$actionInfo = _$_VariacaoStoreActionController.startAction(
        name: '_VariacaoStore.setTipoMoeda');
    try {
